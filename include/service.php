<div class="container py-5">
    ...
    <div class="row g-4 mt-3">
        ...
        <div class="col-md-4">
            <div class="card service-card">
                <img src="images/service/1.jpg" class="card-img-top" alt="Service 1">
                <div class="card-body">
        ...
        <div class="col-md-4">
            <div class="card service-card">
                <img src="images/service/2.jpg" class="card-img-top" alt="Service 2">
                <div class="card-body">
        ...
        <div class="col-md-4">
            <div class="card service-card">
                <img src="images/service/3.jpg" class="card-img-top" alt="Service 3">
                <div class="card-body">
    ...
    <div class="row g-4 mt-3">
        ...
        <div class="col-md-6">
            <div class="card service-card">
                <img src="images/service/4.jpg" class="card-img-top" alt="Service 4">
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card service-card">
                <img src="images/service/5.jpg" class="card-img-top" alt="Service 5">
                <div class="card-body">
