					...
					<nav id="mega-menu-holder" class="clearfix">
						<ul class="clearfix">
							...
							<li class="<?php echo isActive('/jobs'); ?>"><a href="/jobs">Jobs</a>
								<ul class="dropdown">
									<li><a href="https://jobs.elitecorporatesolutions.com/jobseeker/currentjobs">Current
											Jobs</a></li>
									<li><a href="https://jobs.elitecorporatesolutions.com/jobseeker/register">Submit
											CV</a></li>
									<li><a href="https://jobs.elitecorporatesolutions.com/jobseeker/login">Login</a>
									</li>
								</ul>
							</li>
						...
						<li class="search-option">
							<div class="dropdown">
								<button type="button" class="dropdown-toggle" data-toggle="dropdown"><i
										class="fa fa-sarch" aria-hidden="true"></i></button>
