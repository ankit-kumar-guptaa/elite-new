...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        if ($formType === 'employer') {
            ...
            // Email content
            $mail->isHTML(false);
            $mail->Subject = 'New Russian Employer Form Submission';
            $mail->Body = "Company: $company\n"
                        ...
                        . "Form Type: Russian Employer Form";
            
        } elseif ($formType === 'jobseeker') {
            ...
            // Email content
            $mail->isHTML(false);
            $mail->Subject = 'New Russian Job Seeker Application';
            $mail->Body = "Name: $name\n"
                        . "Email: $email\n"
                        . "Phone: $phone\n"
                        ...
                        . "Form Type: Russian Job Seeker Form";
        } else {
            // Invalid form type
    ...
    // Not a POST request
    echo "<script>alert('Invalid request method.'); window.location.href = 'russia-india-services.php';</script>";
    exit();
}