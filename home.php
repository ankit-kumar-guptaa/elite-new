  ...
  gtag('config', 'G-2VDKKW0ZFF');
	...
	<body>
        ...
        <div class="container">
            ...
            <a href="/about" class="btn btn-know-more">Know More →</a>
        </div>
    </section>
						...
						<div class="row">
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-solution-block">
									...
									<h5>Complete recruitment process outsourcing</h5>
							...
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-solution-block">
									...
									<h5>Pay on success fee model</h5>
							...
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-solution-block">
									...
									<h5>Faster turn around times</h5>
							...
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-solution-block">
									...
									<h5>Best fit pre-screening facility with multilevel screening</h5>
							...
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-solution-block">
									...
									<h5>Wide industry skill database for the perfect match</h5>
							...
							<div class="col-lg-4 col-sm-6 col-12">
								<div class="single-solution-block">
									...
									<h5>Head hunting with expert industry connect</h5>
